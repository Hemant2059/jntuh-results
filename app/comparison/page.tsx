...
const resultPages = [
  ...
  // { title: 'Comparison Result', icon: BarChart2, href: '/', color: 'bg-gray-400' },
]
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12">
        <header className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-800 mb-4">Result comparision Portal</h1>
          <p className="text-xl text-gray-600">Compare your academic performance with ease</p>
        </header>
